 ...
 * artifacts to .dk-harness/browse-evidence/ for traceability.
 *
...
export class EvidenceCollector {
  ...
  constructor(projectRoot: string, sessionId?: string) {
    ...
    this.evidenceDir = join(projectRoot, '.dk-harness', 'browse-evidence', this.sessionId);
  ...
  static listSessions(projectRoot: string): string[] {
    const dir = join(projectRoot, '.dk-harness', 'browse-evidence');
  ...
  static loadReport(projectRoot: string, sessionId: string): Result<EvidenceReport> {
    const reportPath = join(projectRoot, '.dk-harness', 'browse-evidence', sessionId, 'report.json');
