...
**dk-harness Builder Philosophy**

16명의 에이전트, 39개의 스킬, 0개의 런타임 의존성.
이 문서는 dk-harness을 만드는 원칙이다. 기능 목록이 아니라 판단 기준이다.
...
dk-harness의 PDCA는 복잡도에 따라 자동 스케일링된다.
...
dk-harness에는 16명의 에이전트가 있다. 각자 이름과 관점을 가진다.
...
dk-harness은 프로젝트 메모리를 통해 세션 간 학습을 유지한다.
...
dk-harness은 9개의 네이티브 Hook으로 에이전트 행동을 모니터링한다:
...
dk-harness은 Node.js 내장 API만으로 동작한다.
...
dk-harness은 Multi-AI consensus (Claude + Codex + Gemini 3-voice voting)를 지원한다.
...
<p align="center">
  <sub>dk-harness Harness Engineering Agent &mdash; Built by <a href="https://github.com/burlesquer">deekee</a></sub>
</p>
