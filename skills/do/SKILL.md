...
# /dk-harness:do — 자연어 자동 라우팅

사용자의 자연어 입력을 분석하여 `plan` / `auto` / `team` 중 최적 dk-harness 파이프라인으로 자동 분배합니다.

## Usage

```
/dk-harness:do <자연어 태스크 설명>
/dk-harness:do "인증 기능 추가해줘"
/dk-harness:do "src/auth.ts에 JWT 검증 미들웨어 추가해줘"
/dk-harness:do "대규모 리팩토링 진행해줘"
```
...
입력: "<originalInput>"
분석: <reason>
라우팅: /dk-harness <route> (<preset> preset)
━━━━━━━━━━━━━━━━━━━━━━━
```
...
라우팅: /dk-harness:auto (solo preset)
━━━━━━━━━━━━━━━━━━━━━━━
```
...
```
Skill("dk-harness:review-pipeline") 호출
...
### route = "review-cso"
```
Skill("dk-harness:review-code") 호출 (CSO 모드)
