...
# /dk-harness test — Test Runner & Coverage Analysis

## Usage
```
/dk-harness test                    — 전체 테스트 실행 + 커버리지 분석
/dk-harness test run                — 테스트 실행만
/dk-harness test cover <target>     — 특정 모듈 커버리지 갭 분석
/dk-harness test gen <target>       — 누락 테스트 자동 생성
```
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  → /dk-harness test gen {target} 으로 누락 테스트 생성
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
