...
# /dk-harness rollback — Git Checkpoint Rollback

## Usage
- `/dk-harness rollback` — 마지막 체크포인트로 롤백
- 비파괴적: 새 브랜치를 생성하고, 변경사항은 git stash에 보존

## How it works
1. 파이프라인 실행 전 자동 체크포인트 생성
2. Milla 리뷰에서 Critical 발견 시 롤백 제안
3. 롤백 시 새 브랜치 생성 (dk-harness-rollback-*)
...
```bash
git stash push -m "dk-harness-checkpoint-{stage}-{timestamp}" --include-untracked
git stash pop
git add -A
...
// Display
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  dk-harness rollback: Selective Retry
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
- Suggest `/dk-harness debug` for root cause analysis
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  Options:
  1. /dk-harness rollback — 마지막 체크포인트로 롤백
  2. /dk-harness debug — 과학적 디버깅으로 전환
  3. 수동 수정
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
