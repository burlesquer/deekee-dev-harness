...
# /dk-harness lsp — Dead Code Detection

## Usage
```
/dk-harness lsp <target>            — 대상 디렉토리/파일 죽은 코드 탐지
/dk-harness lsp                     — 전체 프로젝트 스캔
/dk-harness lsp --fix               — 탐지 + 자동 제거
```
