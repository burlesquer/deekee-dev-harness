...
# /dk-harness qa — Automated QA Loop

## Usage
```
/dk-harness qa [test-command]
/dk-harness qa "npm test"
/dk-harness qa "node --test tests/"
```
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  Suggestion: /dk-harness debug "{errorSig}"
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  Options:
  1. /dk-harness debug — 과학적 디버깅으로 전환
  2. /dk-harness qa — 추가 5 사이클 실행
  3. 수동 수정 후 재시도
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
When used within `/dk-harness team` (team-verify stage):
