...
# /dk-harness perf — Performance Profiling

## Usage
```
/dk-harness perf <target>           — 종합 성능 분석
/dk-harness perf bundle             — 번들 사이즈 분석
/dk-harness perf runtime <target>   — 런타임 핫스팟 분석
/dk-harness perf query <target>     — 쿼리/API 성능 분석
```
