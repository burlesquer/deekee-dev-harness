...
- 예시:
  Agent({ subagent_type: "dk-harness:{name}", name: "{name}-worker-1", model: "haiku",
    prompt: "파일 A, B, C에 대해 {작업} 수행" })
  Agent({ subagent_type: "dk-harness:{name}", name: "{name}-worker-2", model: "haiku",
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  dk-harness auto complete: {feature}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  Learning: saved to .dk-harness/project-memory.json
  Report: .dk-harness/reports/{date}-{feature}.md
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
```
5. This generates `.dk-harness/reports/{date}-{feature}.md`
