...
# /dk-harness:refactor — Structural Refactoring

## Usage
```
/dk-harness:refactor <target>
/dk-harness:refactor "auth 모듈을 서비스 패턴으로 분리"
/dk-harness:refactor src/utils/ "중복 제거"
```
...
Save checkpoint to `.dk-harness/state/checkpoints.json` for rollback.
...
```
Agent({
  subagent_type: "dk-harness:jay",  // or derek for frontend
...
```
Agent({
  subagent_type: "dk-harness:milla",
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  Rollback: /dk-harness:rollback (if needed)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
