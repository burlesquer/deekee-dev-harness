...
# /dk-harness review-pipeline — 4-Tier Review Pipeline
...
```
/dk-harness review-pipeline              # 복잡도 기반 자동 선택
/dk-harness review-pipeline eng          # Eng Review만
/dk-harness review-pipeline ceo          # CEO Review만
/dk-harness review-pipeline design       # Design Review만
