...
# /dk-harness debug — Scientific Debugging

## Usage
```
/dk-harness debug <증상>          — 새 디버그 세션 시작
/dk-harness debug                 — 미완료 세션 재개
/dk-harness debug --list          — 전체 세션 목록 조회
```
...
디버그 세션은 `.dk-harness/debug/{YYYY-MM-DD}-{slug}.md` 에 저장:
