/**
 * dk-harness Display — Colorful terminal output with cute team visualization
...
/**
 * Generate the dk-harness banner
 */
export function banner() {
    return `
${C.bold}${C.purple}  \u250C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2510${C.reset}
${C.bold}${C.purple}  \u2502${C.reset}  ${C.bold}${C.pink}dk-harness${C.reset} ${C.dim}v2.3.1${C.reset}  ${C.italic}Harness Engineering Agent${C.reset}  ${C.bold}${C.purple}\u2502${C.reset}
...
export function teamDisplay() {
    ...
    const lines = [
        '',
        `${C.bold}  dk-harness Agent Team${C.reset}`,
        `${C.dim}  \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500${C.reset}`,
    ];
...
export function commandsHelp() {
    const cmds = [
        // Vibe Coding
        { cmd: '/dk-harness do <\uC790\uC5F0\uC5B4>', desc: 'Auto-route: \uC758\uB3C4 \uBD84\uC11D \u2192 \uCD5C\uC801 \uD30C\uC774\uD504\uB77C\uC778 \uC790\uB3D9 \uC120\uD0DD', icon: icon.route, section: 'Vibe Coding' },
        { cmd: '/dk-harness wizard', desc: 'Iron: \uBE44\uAC1C\uBC1C\uC790\uB3C4 \uC790\uC5F0\uC5B4\uB85C \uD504\uB85C\uC81D\uD2B8 \uC644\uC131', icon: icon.wand },
        { cmd: '/dk-harness init <\uD504\uB85C\uC81D\uD2B8>', desc: 'Project init: \uC9C8\uBB38 \uAE30\uBC18 \uBB38\uB9E5 \uC218\uC9D1 \u2192 \uD504\uB85C\uC81D\uD2B8 \uBB38\uC11C \uC0DD\uC131', icon: `${C.blue}(i)${C.reset}` },
        // Pipeline
        { cmd: '/dk-harness auto <task>', desc: 'Full pipeline: \uC790\uB3D9 \uD300 \uAD6C\uC131 + \uBCD1\uB82C \uC2E4\uD589', icon: `${C.green}|>${C.reset}`, section: 'Pipeline' },
        { cmd: '/dk-harness team [agents] <task>', desc: 'Staged: plan\u2192exec\u2192verify\u2192fix \uB8E8\uD504 (\uD488\uC9C8 \uBCF4\uC7A5)', icon: `${C.purple}||${C.reset}` },
        { cmd: '/dk-harness plan <task>', desc: 'Able+Klay: \uC694\uAD6C\uC0AC\uD56D \uBD84\uC11D \u2192 \uC791\uC5C5 \uBD84\uD574', icon: icon.target },
        { cmd: '/dk-harness explore <target>', desc: 'Klay: \uCF54\uB4DC\uBCA0\uC774\uC2A4 \uD0D0\uC0C9 + \uAD6C\uC870 \uBD84\uC11D', icon: icon.tri },
        // Development
        { cmd: '/dk-harness start <name>', desc: 'PDCA cycle: Plan\u2192Do\u2192Check\u2192Act\u2192Review', icon: `${C.orange}>>${C.reset}`, section: 'Development' },
        { cmd: '/dk-harness tdd start <feat>', desc: 'TDD: \uD83D\uDD34Red\u2192\uD83D\uDFE2Green\u2192\uD83D\uDD35Refactor', icon: `${C.red}(R)${C.reset}` },
        { cmd: '/dk-harness execute <task>', desc: 'Jay+Derek: Backend + Frontend \uAD6C\uD604', icon: icon.gear },
        { cmd: '/dk-harness debug <\uC99D\uC0C1>', desc: 'Scientific debug: \uAC00\uC124\u2192\uD14C\uC2A4\uD2B8\u2192\uACB0\uB860 (\uC601\uAD6C \uC0C1\uD0DC)', icon: `${C.orange}!${C.reset}` },
        // Quality
        { cmd: '/dk-harness review', desc: 'Milla: \uBCF4\uC548 + \uCF54\uB4DC \uD488\uC9C8 \uB9AC\uBDF0', icon: icon.lock, section: 'Quality' },
        { cmd: '/dk-harness verify', desc: 'Sam: \uC99D\uAC70 \uCCB4\uC778 + \uBAA9\uD45C \uB2EC\uC131 \uAC80\uC99D', icon: icon.star },
        { cmd: '/dk-harness cost', desc: 'Cost report: \uC5D0\uC774\uC804\uD2B8\uBCC4 \uD1A0\uD070/\uBE44\uC6A9 \uCD94\uC815', icon: icon.chart },
        // Utility
        { cmd: '/dk-harness rollback', desc: 'Git checkpoint \uB864\uBC31', icon: `${C.orange}<>>${C.reset}`, section: 'Utility' },
        { cmd: '/dk-harness status', desc: 'Dashboard (PDCA+TDD+Task)', icon: icon.chart },
        { cmd: '/dk-harness help', desc: 'This help', icon: `${C.sky}[?]${C.reset}` },
    ];
    const lines = [
        '',
...
export function bestPracticesGuide() {
    const lines = [
        ...
        `     ${C.cyan}/dk-harness do "\uC6D0\uD558\uB294 \uAC83\uC744 \uC790\uC5F0\uC5B4\uB85C"${C.reset}`,
        `     ${C.dim}\u2192 \uC758\uB3C4 \uBD84\uC11D \u2192 auto/plan/team \uC790\uB3D9 \uC120\uD0DD${C.reset}`,
        `     ${C.dim}\uC608: /dk-harness do "\uB85C\uADF8\uC778 \uAE30\uB2A5 \uCD94\uAC00\uD574\uC918"${C.reset}`,
        `     ${C.dim}\uC608: /dk-harness do "src/auth.ts\uC5D0 JWT \uAC80\uC99D \uCD94\uAC00"${C.reset}`,
        '',
        `  ${C.bold}${C.magenta}2. \uBE44\uAC1C\uBC1C\uC790\uB77C\uBA74${C.reset}`,
        `     ${C.cyan}/dk-harness wizard${C.reset}`,
        `     ${C.dim}\u2192 Iron\uC774 \uC9C8\uBB38\uD558\uBA74 \uB2F5\uB9CC \uD558\uBA74 \uB429\uB2C8\uB2E4${C.reset}`,
        '',
        `  ${C.bold}${C.blue}3. \uC0C8 \uD504\uB85C\uC81D\uD2B8 \uC2DC\uC791${C.reset}`,
        `     ${C.cyan}/dk-harness init \u2192 /dk-harness do "\uCCAB \uAE30\uB2A5"${C.reset}`,
        `     ${C.dim}\u2192 \uD504\uB85C\uC81D\uD2B8 \uBB38\uB9E5 \uC218\uC9D1 \uD6C4 \uBC14\uB85C \uAC1C\uBC1C \uC2DC\uC791${C.reset}`,
        '',
        `  ${C.bold}${C.orange}4. \uBE60\uB978 \uC218\uC815${C.reset}`,
        `     ${C.cyan}/dk-harness auto "\uAD6C\uCCB4\uC801 \uC791\uC5C5"${C.reset}`,
        `     ${C.dim}\u2192 \uD30C\uC77C/\uD568\uC218\uBA85 \uD3EC\uD568\uD558\uBA74 Solo \uBAA8\uB4DC\uB85C \uC989\uC2DC \uC2E4\uD589${C.reset}`,
        '',
        `  ${C.bold}${C.purple}5. \uB300\uADDC\uBAA8 \uAE30\uB2A5${C.reset}`,
        `     ${C.cyan}/dk-harness team "\uB300\uADDC\uBAA8 \uC791\uC5C5"${C.reset}`,
        `     ${C.dim}\u2192 plan\u2192exec\u2192verify\u2192fix \uD488\uC9C8 \uB8E8\uD504${C.reset}`,
        '',
        `  ${C.bold}${C.red}6. \uBC84\uADF8 \uC7A1\uAE30${C.reset}`,
        `     ${C.cyan}/dk-harness debug "\uC99D\uC0C1 \uC124\uBA85"${C.reset}`,
        `     ${C.dim}\u2192 \uAC00\uC124\u2192\uD14C\uC2A4\uD2B8\u2192\uACB0\uB860, \uC138\uC158 \uB04A\uACE8\uB3C4 \uC7AC\uAC1C \uAC00\uB2A5${C.reset}`,
        '',
        `  ${C.dim}  Tip: \uBAA8\uB974\uACA0\uC73C\uBA74 /dk-harness do \uC5D0 \uC544\uBB34\uAC70\uB098 \uC368\uBCF4\uC138\uC694.${C.reset}`,
        `  ${C.dim}  dk-harness\uC774 \uC54C\uC544\uC11C \uCD5C\uC801 \uACBD\uB85C\uB97C \uCC3E\uC544\uC90D\uB2C8\uB2E4.${C.reset}`,
    ];
    return lines.join('\n');
}
/**
...
export function fullHelp() {
    return [
        ...
        '',
        `${C.dim}  \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500${C.reset}`,
        `  ${C.dim}GitHub: ${C.reset}${C.sky}burlesquer/deekee-dev-harness${C.reset}`,
        `  ${C.dim}Install: ${C.reset}${C.sky}/plugin marketplace add burlesquer/deekee-dev-harness${C.reset}`,
        '',
    ].join('\n');
}
