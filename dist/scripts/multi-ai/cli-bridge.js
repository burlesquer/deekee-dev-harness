/**
 * dk-harness CLI Bridge Factory — Unified interface for external AI CLI tools.
...
export function buildCodexDelegationSuggestion(taskType) {
    ...
    if (detection.tier === 'plugin') {
        ...
        return `[dk-harness:codex-delegation] Codex plugin이 감지되었습니다. ${cmd} 명령으로 Codex에 위임할 수 있습니다.`;
    }
    // CLI tier — use cli-bridge
    return `[dk-harness:codex-delegation] Codex CLI가 감지되었습니다. 리뷰를 Codex에 위임하면 독립적인 second opinion을 받을 수 있습니다.`;
}
// ── Utilities ──────────────────────────────────────────────────────────
/**
