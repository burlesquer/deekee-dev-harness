 ...
 *
 * 저장 위치: .dk-harness/learning/knowledge.json
...
function getKnowledgePath(projectDir) {
    return join(projectDir, '.dk-harness', 'learning', KNOWLEDGE_FILE);
}
...
export function generateSummary(projectDir) {
    ...
    if (profile.concepts.length === 0) {
        return '아직 학습 기록이 없습니다. `/dk-harness teacher <task>`로 시작해보세요.';
    }
