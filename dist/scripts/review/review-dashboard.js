/**
 * dk-harness Review Readiness Dashboard
...
const REVIEW_TIERS = [
    { key: 'eng-review', label: 'Eng Review', required: true, trigger: '/dk-harness review eng' },
    { key: 'ceo-review', label: 'CEO Review', required: false, trigger: '/dk-harness review ceo' },
    { key: 'design-review', label: 'Design Review', required: false, trigger: '/dk-harness review design' },
    { key: 'outside-voice', label: 'Outside Voice', required: false, trigger: '/dk-harness review outside' },
];
/**
