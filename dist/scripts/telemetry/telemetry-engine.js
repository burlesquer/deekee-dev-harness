/**
 * dk-harness Telemetry Engine — Session Analytics
 *
 ...
 *
 * Integration with dk-harness Context Budget:
...
export const TELEMETRY_DIR = '.dk-harness/telemetry';
