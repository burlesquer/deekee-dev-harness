/**
 * dk-harness Analytics — Usage statistics dashboard
 * @module scripts/cli/dk-harness-analytics
 */
...
export function generateAnalyticsReport(window = '7d', projectDir) {
    ...
    const lines = [
        `dk-harness analytics (last ${days} days)`,
        '\u2501'.repeat(50),
    ];
...
//# sourceMappingURL=dk-harness-analytics.js.map