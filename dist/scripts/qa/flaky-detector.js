/**
 * dk-harness Flaky Test Detector — Identifies tests with inconsistent pass/fail results
...
/**
 * Save flaky report to .dk-harness/qa/flaky-report.json.
 */
export function saveFlakyReport(projectDir, report) {
    const path = join(projectDir, '.dk-harness', 'qa', 'flaky-report.json');
