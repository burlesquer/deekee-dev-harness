 ...
 */
export declare function resolveShipSteps(): string;
/**
 * Generate ship prerequisites checklist.
 */
export declare function resolveShipPrerequisites(): string;
//# sourceMappingURL=ship-resolver.d.ts.map