 ...
 */
export declare function resolveEvidenceTypes(): string;
/**
 * Generate LLM judge criteria table.
 */
export declare function resolveJudgeCriteria(): string;
//# sourceMappingURL=evidence-resolver.d.ts.map