...
export function buildCompactionContext(projectDir) {
    ...
    const pdcaState = readStateOrDefault(join(dir, '.dk-harness', 'state', 'pdca-status.json'), null);
    ...
    const agentState = readStateOrDefault(join(dir, '.dk-harness', 'state', 'agent-tracker.json'), null);
    ...
    const denialState = readStateOrDefault(join(dir, '.dk-harness', 'state', 'denial-audit.json'), null);
    ...
    const tracker = readStateOrDefault(join(dir, '.dk-harness', 'state', 'invariants-tracker.json'), null);
    ...
    const memory = readStateOrDefault(join(dir, '.dk-harness', 'project-memory.json'), null);
    if (memory) {
        const parts = [];
