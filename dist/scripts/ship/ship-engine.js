/**
 * dk-harness Ship Engine — Automated Ship Workflow
 * Integrates with dk-harness's PDCA review stage and evidence chain.
 *
 * Pipeline:
...
export function initShip(feature, branch, baseBranch, projectDir) {
    ...
    const statePath = join(dir, '.dk-harness', 'state', 'ship-state.json');
