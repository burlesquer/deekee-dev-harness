/**
 * dk-harness SubagentStop Hook Handler v2.0.0
 * Updates agent-trace.json: marks agent completed/failed with duration.
 * Auto-checks matching subtask in .dk-harness/tasks/ on success.
...
try {
    ...
    const context = [
        `[dk-harness:agent-trace] SubagentStop: ${agentName} (${subagentType}) -> ${statusIcon} in ${durationStr}`,
