/**
 * Unit tests for scripts/research/dk-harness-opus-audit.ts
 * Pure parser + classifier coverage. No filesystem I/O.
 */
import { describe, it, expect } from 'vitest';
import { parseFrontmatterModel, parseAgentDefaults, parseAgentTiers, parseOrchestratorHardcoded, parseRosterFromClaudeMd, classifyAgent, formatAuditMarkdown, } from '../../../scripts/research/dk-harness-opus-audit.js';
...
describe('formatAuditMarkdown', () => {
    it('renders all required section headers', () => {
        ...
        expect(md).toContain('# dk-harness Opus Audit');
...
//# sourceMappingURL=dk-harness-opus-audit.test.js.map