...
describe('getCostMode', () => {
    const originalEnv = process.env.DK_COST_MODE;
    afterEach(() => {
        if (originalEnv === undefined) {
            delete process.env.DK_COST_MODE;
        }
        else {
            process.env.DK_COST_MODE = originalEnv;
        }
    });
