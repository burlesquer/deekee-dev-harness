...
describe('addEvidence', () => {
    it('creates a new chain when none exists', () => {
        ...
        const path = '/tmp/project/.dk-harness/state/evidence-login.json';
    ...
    it('appends to existing chain with incremented seq', () => {
        const path = '/tmp/project/.dk-harness/state/evidence-auth.json';
        chainStore[path] = {
            feature: 'auth',
    ...
    it('includes optional details', () => {
        ...
        const path = '/tmp/project/.dk-harness/state/evidence-api.json';
        const stored = chainStore[path];
...
describe('evaluateChain', () => {
    ...
    it('returns PASS when all entries are pass', () => {
        const path = '/tmp/project/.dk-harness/state/evidence-feature-a.json';
        chainStore[path] = {
            feature: 'feature-a',
            entries: [
    ...
    it('returns PASS when entries are pass or not_available', () => {
        const path = '/tmp/project/.dk-harness/state/evidence-feature-b.json';
        chainStore[path] = {
            feature: 'feature-b',
            entries: [
                { type: 'test', result: 'pass', source: 'vitest', seq: 1 },
    ...
    it('returns FAIL when any entry is fail', () => {
        const path = '/tmp/project/.dk-harness/state/evidence-feature-c.json';
        chainStore[path] = {
            feature: 'feature-c',
            entries: [
                { type: 'test', result: 'pass', source: 'vitest', seq: 1 },
    ...
    it('returns INCOMPLETE when results are mixed (no fail but not all pass)', () => {
        const path = '/tmp/project/.dk-harness/state/evidence-feature-d.json';
        chainStore[path] = {
            feature: 'feature-d',
            entries: [
                { type: 'test', result: 'pass', source: 'vitest', seq: 1 },
    ...
    it('persists verdict back to state', () => {
        const path = '/tmp/project/.dk-harness/state/evidence-feature-e.json';
        chainStore[path] = {
            feature: 'feature-e',
    ...
    it('generates formatted summary lines', () => {
        const path = '/tmp/project/.dk-harness/state/evidence-feature-f.json';
        chainStore[path] = {
            feature: 'feature-f',
            entries: [
                { type: 'test', result: 'pass', source: 'vitest', seq: 1 },
...
describe('formatChain', () => {
    it('formats chain with verdict for display', () => {
        const path = '/tmp/project/.dk-harness/state/evidence-display.json';
        chainStore[path] = {
            feature: 'display',
            entries: [
                { type: 'test', result: 'pass', source: 'vitest', seq: 1 },
    ...
    it('shows FAIL verdict when entries have failures', () => {
        const path = '/tmp/project/.dk-harness/state/evidence-broken.json';
        chainStore[path] = {
            feature: 'broken',
            entries: [
