/**
 * dk-harness Setup Progress Manager
...
const STATE_FILE = '.dk-harness/state/setup-state.json';
const CONFIG_FILE: string = join(homedir(), '.claude', '.dk-harness-config.json');
