...
export function formatAgentTiers(agents: PipelineAgent[]): string {
  if (agents.length === 0) return '[dk-harness Agent Tiers] No agents configured';

  const lines: string[] = [
    '[dk-harness Agent Tier Matrix]',
    '  ┌────────────────────┬────────┬──────┬─────────┬──────────────────────────────────┐',
