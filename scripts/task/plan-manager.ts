/**
 * dk-harness Plan Manager v1.1.0
 * Creates and manages plan documents in .dk-harness/plans/
...
function getPlanDir(projectDir?: string): string {
  const dir = join(projectDir || process.cwd(), '.dk-harness', 'plans');
...
export function createPlan(params: CreatePlanParams, projectDir?: string): CreatePlanResult {
  ...
  md.push(``, `---`, `*Generated by dk-harness Plan Manager*`);
