/**
 * dk-harness Harness Evolution — Version tracking + A/B comparison
...
function historyDir(projectDir: string, feature: string): string {
  return join(projectDir, '.dk-harness', 'harness-history', sanitizeFeature(feature));
}
...
export function formatHistory(feature: string, versions: HarnessVersion[]): string {
  const lines: string[] = [
    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    `  dk-harness harness log: ${feature}`,
    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    '',
...
export function formatComparison(comp: VersionComparison): string {
  ...
  const lines: string[] = [
    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    `  dk-harness harness log: v${comp.v1.version} vs v${comp.v2.version} ${icon}`,
    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    '',
  ];
