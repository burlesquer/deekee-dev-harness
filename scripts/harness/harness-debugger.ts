/**
 * dk-harness Harness Debugger — Runtime diagnosis for harness issues
...
function generateSuggestions(
  ...
  if (stalled.length > config.agents.length / 2) {
    suggestions.push({
      type: 'skip',
      detail: '과반 에이전트가 멈춤. /dk-harness debug로 근본 원인 분석을 권장합니다.',
      priority: 'high',
    });
  }
...
export function formatDiagnosis(result: DiagnosisResult): string {
  ...
  const lines: string[] = [
    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    `  dk-harness harness fix: ${statusIcon[result.status]}`,
    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    '',
  ];
