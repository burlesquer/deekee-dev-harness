/**
 * dk-harness Version Detect v2.0.0
 * Detects project tech stack versions from all dependency files.
 * Caches to .dk-harness/state/tech-stack.json with git-based invalidation.
...
function cachePath(dir: string): string { return join(dir, '.dk-harness', 'state', 'tech-stack.json'); }
