...
/**
 * dk-harness Skill Document Generator
 *
...
function buildPlaceholders(): Placeholders {
  ...
  const commands = [
    '/dk-harness plan', '/dk-harness auto', '/dk-harness team', '/dk-harness explore',
    '/dk-harness review', '/dk-harness task', '/dk-harness debug', '/dk-harness test',
    '/dk-harness refactor', '/dk-harness do', '/dk-harness tdd', '/dk-harness qa-loop',
    '/dk-harness rollback', '/dk-harness verify-evidence'
  ].join(', ');
